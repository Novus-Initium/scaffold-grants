      ...
      <div>
        <div className="fixed flex justify-between items-center w-full z-10 p-4 bottom-0 left-0 pointer-events-none">
          <div className="flex flex-col md:flex-row gap-2 pointer-events-auto">
            <div>
              <Link href="/debug">
                <div className="btn btn-primary btn-sm hover:bg-secondary hover:text-white font-normal gap-1 rounded-md">
        ...
        <ul className="menu menu-horizontal w-full">
          <div className="flex justify-center items-center gap-2 text-sm w-full">
            <div className="text-center">
              <a href="https://github.com/Novus-Initium/Scaffold-Grants-Stack" target="_blank" rel="noreferrer" className="link">
                Fork me
              </a>
            </div>
            <span>·</span>
            <div className="flex justify-center items-center gap-2">
              ...
              >
                ...
                <span className="link">Ninit via BuidlGuidl</span>
              </a>
            </div>
            <span>·</span>
            <div className="text-center">
